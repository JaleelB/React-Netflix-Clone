...
const Movies = ({fullscreenProps}) => {
    ...
    useEffect(() => {
        ...
        axios
        .get(`${apiComponents[0]}${apiComponents[2].discover_movie}?api_key=${apiComponents[1]}&certification_country=US&certification.lte=G&sort_by=popularity.desc`)
        .then((res)=> {
    ...
    // console.log(`${apiComponents[0]}${apiComponents[2].discover_movie}?api_key=${apiComponents[1]}&certification_country=US&certification.lte=G&sort_by=popularity.desc`)
